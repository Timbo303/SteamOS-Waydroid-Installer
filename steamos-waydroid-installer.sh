...
if [ $? -eq 0 ]
then
	echo pikaur AUR Helper successfully installed!
else
	echo Error Installing pikaur
	cleanup_exit
fi
...
if [ $? -eq 0 ]
then
	echo wayland-chromium successfully installed!
else
	echo Error Installing wayland-chromium
	cleanup_exit
fi
